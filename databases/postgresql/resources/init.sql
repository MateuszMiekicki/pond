...
CREATE TABLE visitor { id SERIAL,
user_id SERIAL,
device_id SERIAL,
...
CONSTRAINT visitor_fk FOREIGN KEY (visitor_id) REFERENCES visitor (id) };
CREATE TABLE general_alert { id SERIAL,
device_id SERIAL,
date TIMESTAMP NOT NULL,
description VARCHAR NOT NULL,
served BOOLEAN NOT NULL,
PRIMARY KEY (id),
CONSTRAINT device_fk FOREIGN KEY (device_id) REFERENCES device (id) };
CREATE TABLE pet { id SERIAL,
name VARCHAR NOT NULL,
description VARCHAR,
PRIMARY KEY (id) };
CREATE TABLE pet_habitat { id SERIAL,
pet_id SERIAL,
PRIMARY KEY (id),
